      ...
      <div className="p-8 relative z-10">
          ...
          <div className="flex-1">
            <div className="text-center md:text-left space-y-3">
              ...
              <p className="text-base md:text-lg max-w-2xl text-muted-foreground leading-relaxed">
                Building the Future of Web3 and AI with Code ⚡ Passionate software 
                developer specializing in blockchain technologies, web development, 
                and AI integration.
              </p>
            </div>
        ...
        <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={index} className="bg-white/5 backdrop-blur-sm rounded-lg p-4 text-center hover:bg-neon/5 transition-colors duration-300 group">
              <div className="text-2xl font-bold text-neon group-hover:scale-110 transition-transform duration-300">{stat.value}</div>
              <div className="text-sm text-muted-foreground group-hover:text-white transition-colors duration-300">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
